...
const BoardMemberId = Nat;
const BoardMember = Record({
  "id": BoardMemberId,
  "bio": Text,
  "linkedIn": Text,
  "title": Text,
...
const SubmitApplicationArgs = Record({
  "applicantName": Text,
  "jobId": JobId,
  "email": Text,
  "message": Text
});
const SubmitContactArgs = Record({
  "subject": Text,
  "name": Text,
  "email": Text,
  "message": Text
});
const UpdateBoardMemberArgs = Record({
  "id": BoardMemberId,
  "bio": Text,
  "linkedIn": Text,
  "title": Text,
...
const UpdateFirmInfoArgs = Record({
  "missionStatement": Text,
  "statsJson": Text,
  "heroCopy": Text,
  "investmentStrategy": Text,
...
Service({
  "createBoardMember": Func([CreateBoardMemberArgs], [BoardMember], []),
  "createBrand": Func([CreateBrandArgs], [Brand], []),
  ...
  "getBrand": Func([BrandId], [Opt(Brand)], ["query"]),
  "getFirmInfo": Func([], [FirmInfo], ["query"]),
  "getJob": Func([JobId], [Opt(Job)], ["query"]),
  "listActiveJobs": Func([], [Vec(Job)], ["query"]),
  "listApplications": Func([], [Vec(JobApplication)], ["query"]),
  "listApplicationsForJob": Func(
    [JobId],
    [Vec(JobApplication)],
    ["query"]
  ),
  "listBoardMembers": Func([], [Vec(BoardMember)], ["query"]),
  "listBrands": Func([], [Vec(Brand)], ["query"]),
  ...
  "updateBrand": Func([UpdateBrandArgs], [Opt(Brand)], []),
  "updateFirmInfo": Func([UpdateFirmInfoArgs], [FirmInfo], []),
  "updateJob": Func([UpdateJobArgs], [Opt(Job)], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const CreateBoardMemberArgs2 = IDL2.Record({
    "bio": IDL2.Text,
    "linkedIn": IDL2.Text,
    "title": IDL2.Text,
    "order": IDL2.Nat,
  ...
  const BoardMemberId2 = IDL2.Nat;
  const BoardMember2 = IDL2.Record({
    "id": BoardMemberId2,
    "bio": IDL2.Text,
    "linkedIn": IDL2.Text,
    "title": IDL2.Text,
  ...
  const CreateBrandArgs2 = IDL2.Record({
    "order": IDL2.Nat,
    "name": IDL2.Text,
  ...
  const BrandId2 = IDL2.Nat;
  const Brand2 = IDL2.Record({
    "id": BrandId2,
    "order": IDL2.Nat,
    "name": IDL2.Text,
    "description": IDL2.Text,
  ...
  const FirmInfo2 = IDL2.Record({
    ...
    "statsJson": IDL2.Text,
    "heroCopy": IDL2.Text,
    "investmentStrategy": IDL2.Text,
    "heroHeadline": IDL2.Text
  });
  const ApplicationId2 = IDL2.Nat;
  const Timestamp2 = IDL2.Int;
  const JobApplication2 = IDL2.Record({
    "id": ApplicationId2,
    "applicantName": IDL2.Text,
    "jobId": JobId2,
    "submittedAt": Timestamp2,
    "email": IDL2.Text,
    "message": IDL2.Text
  });
  const ContactSubmissionId2 = IDL2.Nat;
  const ContactSubmission2 = IDL2.Record({
    "id": ContactSubmissionId2,
    "subject": IDL2.Text,
    "name": IDL2.Text,
    "submittedAt": Timestamp2,
    "email": IDL2.Text,
  ...
  const SubmitApplicationArgs2 = IDL2.Record({
    "applicantName": IDL2.Text,
    "jobId": JobId2,
    "email": IDL2.Text,
    "message": IDL2.Text
  });
  const SubmitContactArgs2 = IDL2.Record({
    "subject": IDL2.Text,
    "name": IDL2.Text,
    "email": IDL2.Text,
    "message": IDL2.Text
  });
  const UpdateBoardMemberArgs2 = IDL2.Record({
    "id": BoardMemberId2,
    "bio": IDL2.Text,
    "linkedIn": IDL2.Text,
    "title": IDL2.Text,
  ...
  const UpdateBrandArgs2 = IDL2.Record({
    "id": BrandId2,
    "order": IDL2.Nat,
    "name": IDL2.Text,
    "description": IDL2.Text,
  ...
  const UpdateFirmInfoArgs2 = IDL2.Record({
    "missionStatement": IDL2.Text,
    "statsJson": IDL2.Text,
    "heroCopy": IDL2.Text,
    "investmentStrategy": IDL2.Text,
  ...
  return IDL2.Service({
    "createBoardMember": IDL2.Func([CreateBoardMemberArgs2], [BoardMember2], []),
    "createBrand": IDL2.Func([CreateBrandArgs2], [Brand2], []),
    ...
    "getBrand": IDL2.Func([BrandId2], [IDL2.Opt(Brand2)], ["query"]),
    "getFirmInfo": IDL2.Func([], [FirmInfo2], ["query"]),
    "getJob": IDL2.Func([JobId2], [IDL2.Opt(Job2)], ["query"]),
    "listActiveJobs": IDL2.Func([], [IDL2.Vec(Job2)], ["query"]),
    "listApplications": IDL2.Func([], [IDL2.Vec(JobApplication2)], ["query"]),
    "listApplicationsForJob": IDL2.Func(
      [JobId2],
      [IDL2.Vec(JobApplication2)],
      ["query"]
    ),
    "listBoardMembers": IDL2.Func([], [IDL2.Vec(BoardMember2)], ["query"]),
    "listBrands": IDL2.Func([], [IDL2.Vec(Brand2)], ["query"]),
    ...
    "submitContact": IDL2.Func([SubmitContactArgs2], [ContactSubmission2], []),
    "updateBoardMember": IDL2.Func(
      [UpdateBoardMemberArgs2],
      [IDL2.Opt(BoardMember2)],
      []
    ),
    "updateBrand": IDL2.Func([UpdateBrandArgs2], [IDL2.Opt(Brand2)], []),
    "updateFirmInfo": IDL2.Func([UpdateFirmInfoArgs2], [FirmInfo2], []),
...
class Backend {
  ...
  async listApplicationsForJob(arg0) {
    if (this.processError) {
      try {
...
function useBrand(id2) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["brand", id2 == null ? void 0 : id2.toString()],
    queryFn: async () => {
      if (!actor || id2 === void 0) return null;
      return actor.getBrand(id2);
    },
...
export {
  ...
  useBrand as b,
  cn as c,
  useBoardMembers as d,
  useSubmitContact as e,
  useActiveJobs as f,
