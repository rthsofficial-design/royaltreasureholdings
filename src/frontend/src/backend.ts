...
import type { BoardMember as _BoardMember, Brand as _Brand, Cell as _Cell, CreateJobArgs as _CreateJobArgs, Job as _Job, JobId as _JobId, JobType as _JobType, Result as _Result, UpdateJobArgs as _UpdateJobArgs, Value as _Value } from "./declarations/backend.did.d.ts";
...
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_BoardMember]): BoardMember | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Brand]): Brand | null {
    return value.length === 0 ? null : value[0];
}
...
function to_candid_UpdateJobArgs_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UpdateJobArgs): _UpdateJobArgs {
